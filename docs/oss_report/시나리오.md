...
| | 안면 인식 및 3D 매핑 | 🟡 기반 구현 | `40%` | [`src/.../tools/camera.py`](file:///d:/git/reachy_mini_conversation_app/src/reachy_mini_conversation_app/tools/camera.py), [`src/.../tools/head_tracking.py`](file:///d:/git/reachy_mini_conversation_app/src/reachy_mini_conversation_app/tools/head_tracking.py) (비전 캡처 연동, 3D 좌표화는 고도화 과제) |
